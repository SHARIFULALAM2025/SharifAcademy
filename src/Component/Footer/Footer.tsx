          ...
          <div className="md:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-[#141E30] border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:border-emerald-500 hover:bg-[#064E3B]/20 transition-all duration-300 group shadow-sm"
              >
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a
                  href="#"
                  className="hover:text-emerald-400 flex items-center gap-1 group transition-colors duration-200"
                >
              ...
              <li className="flex items-start gap-3 bg-[#141E30]/50 border border-gray-800/40 p-3 rounded-xl hover:border-emerald-500/30 transition-all group">
                ...
                <div className="space-y-0.5">
                  ...
                  <a
                    ...
                    className="text-white hover:text-emerald-400 transition-colors font-medium break-all"
                  >
